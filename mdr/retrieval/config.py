...
def common_args():
	...
	# task
	parser.add_argument(
		"--train_file", type=str, default="../data/nq-with-neg-train.txt"
	)
	parser.add_argument(
		"--predict_file", type=str, default="../data/nq-with-neg-dev.txt"
	)
	...
	parser.add_argument(
		"--scheme",
		type=str,
		help="how to get the multivector, layerwise or tokenwise",
		default="none",
	)
...
def train_args():
	...
	parser.add_argument(
		"--warmup-ratio", default=0, type=float, help="Linear warmup over warmup_steps."
	)
